                                    ...
                                    <div data-mdb-input-init class="form-outline mb-4">
                                        ...
                                        <div style="position: relative;">
                                            <input :type="showNewPassword ? 'text' : 'password'"
                                                v-model="nhan_vien.password" id="form2Example17"
                                    ...
                                    <div data-mdb-input-init class="form-outline mb-4">
                                        ...
                                        <div style="position: relative;">
                                            <input :type="showConfirmPassword ? 'text' : 'password'"
                                                v-model="nhan_vien.re_password" id="form2Example17_confirm"
                                                class="form-control form-control-lg" />
...
export default {
    ...
    data() {
        return {
            nhan_vien: {
                'id': this.$route.params.id_nhan_vien
            },
    ...
    methods: {
        doiMatKhau() {
            axios
                .post("http://127.0.0.1:8000/api/nhan-vien/doi-mat-khau", this.nhan_vien)
                .then((res) => {
                    if (res.data.status) {
