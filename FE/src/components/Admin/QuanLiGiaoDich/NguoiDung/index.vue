    ...
    <div class="page-wrapper">
        <div class="page-content mb" style="margin-top: -90px;">
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-4">
                <div class="breadcrumb-title pe-3">Lịch Sử Giao Dịch Người Dùng</div>
                <div class="ps-3">
                        ...
                        <table class="table mb-0">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="text-center">Họ Và Tên Người Dùng</th>
                                    <th class="text-center">SĐT Người Dùng</th>
                                    <th class="text-center">Ngày Giao Dịch</th>
                                    <th class="text-center">Nội Dung Chuyển</th>
                                    <th class="text-center">Phương Thức Thanh Toán</th>
                                    <th class="text-center">Số Tiền Đã Chuyển (VNĐ)</th>
                                    <th class="text-center">Số Tiền Đã Nhận (VNĐ)</th>
                            ...
                            <tbody>
                                <template v-for="(value, index) in lSGiaoDich" :key="index">
                                    <tr>
                                        ...
                                        <td class="text-center">{{ value.nguoi_dung.ho_va_ten }}</td>
                                        <td class="text-center">{{ value.nguoi_dung.so_dien_thoai }}</td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button v-else type="button" class="btn text-nowrap mb-2"
                                                style="background-color: #33e3ff; color: white;">
                                                Thanh Toán Đơn dịch vụ
                                            </button>
                                        </td>
                                        <td class="text-center">
                                            <button v-if="value.is_done == 1" type="button"
                                                class="btn btn-custom btn-success text-nowrap mb-2">
                                                Đã Hoàn Thành
                                            </button>
                                            <button v-else type="button"
                                                class="btn btn-custom btn-warning text-nowrap mb-2">
                                                Chưa Hoàn Thành
                                            </button>
                                        </td>
                                    </tr>
...
export default {
    ...
    methods: {
        ...
        searchGiaoDich() {
            ...
            axios
                .post("http://127.0.0.1:8000/api/admin/search-giao-dich-nguoi-dung",
                    {
        ...
        loadlSGiaoDich() {
            axios
                .get("http://127.0.0.1:8000/api/admin/giao-dich-nguoi-dung", {
                    headers: {
                        Authorization: 'Bearer ' + localStorage.getItem("token_admin")
                    }
                })
...
.page-content {
    margin-top: 0;
    /* Đưa phần nội dung sát hơn lên trên */
    padding-top: 5px;
    /* Chỉ thêm khoảng cách tối thiểu nếu cần */
}
